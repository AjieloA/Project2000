...
public class ABMgr : SingletonAutoMono<ABMgr>
{
    ...
    #region 异步加载内的资源
    //异步加载
    public void AsyncLoadABRes(string _abName, string _resName, UnityAction<Object> _callBck)
    {
        StartCoroutine(AsyncLoadABResIE(_abName, _resName, _callBck));
    }
    public void AsyncLoadABRes(string _abName, string _resName, System.Type _type, UnityAction<Object> _callBck)
    {
        StartCoroutine(AsyncLoadABResIE(_abName, _resName, _type, _callBck));
    }
    public void AsyncLoadABRes<T>(string _abName, string _resName, UnityAction<T> _callBck) where T : Object
    {
